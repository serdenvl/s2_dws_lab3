...
def data_to():
    ...
    return render_template('simple.html', **values)
...
app.config['RECAPTCHA_PUBLIC_KEY'] = '6Lds8HQgAAAAAD9jAxy3YnIaKMK7BNy1ZNGayjm9'
app.config['RECAPTCHA_PRIVATE_KEY'] = '6Lds8HQgAAAAAIiQH-dnlOIlaEMhaZnx_2JadK7L'
